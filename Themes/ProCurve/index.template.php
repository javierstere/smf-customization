...
function template_init()
{
	...
	$settings['theme_variants'] = array('blue', 'grey',);
...
echo '
	...
	echo '
		 <div id="header">
			<h1 class="forumtitle">
				<a style="display: flex;" class="top" href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? '<img src="'. $settings['images_url']. '/custom/logo.png" alt="' . $context['forum_name'] . '" title="' . $context['forum_name'] . '">' : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" title="' . $context['forum_name'] . '">', '</a>
			</h1>';
	...
	echo '
		<div id="upper_section">
			<div id="inner_section">
					<div id="inner_wrap"', !$context['user']['is_logged'] ? : '', '>
				  <div class="navbox">
					  <div class="row">
						  <div class="column">
					<div class="user">';
	...
	if ($context['user']['is_logged']) 
	{
		echo '
		 <ul id="quick_menu">
		 	<li><i class="fa-solid fa-bars"></i><A href="#">	', $txt['quick_menu'], '</a>
		 		<ul>
		 			<li><a href="', $scripturl, '?action=unread" title="', $txt['unread_since_visit'], '">', $txt['view_unread_category'], '</a></li>
		 			<li><a href="', $scripturl, '?action=unreadreplies" title="', $txt['show_unread_replies'], '">', $txt['unread_replies'], '</a></li>
		 			<li><a href="', $scripturl, '?action=recent" title="', $txt['recent_view'], '">', $txt['recent_posts'], '</a></li>
		 			<li><a href="', $scripturl, '?action=mlist" title="', $txt['member_list'], '">', $txt['member_list'], '</a></li>
		 			<li><a href="', $scripturl, '?action=calendar" title="', $txt['calendar'], '">', $txt['calendar'], '</a></li>
		 		</ul>
		 	</li>
		 </ul>';
	}
	...
	elseif (empty($maintenance))
	{
		echo '
		 <ul id="quick_menu">
		 	<li><i class="fa-solid fa-bars"></i>	', $txt['quick_menu'], '
		 		<ul>
		 			<li><a href="', $scripturl, '?action=recent" title="', $txt['recent_view'], '">', $txt['recent_posts'], '</a></li>
		 		</ul>
		 	</li>
  ...
  // Time		  
		echo ' <div class="time_news_section"> ';

		if ($context['user']['is_logged'])
		echo '

		<div class="time_section"><p>', $txt['time_currently'], '</p><time datetime="', smf_gmstrftime('%FT%TZ'), '">', $context['current_time'], '</time></div>';
...
function template_body_below()
{
	...
	echo '
		<ul>
			...
			<li><a href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? $context['forum_name_html_safe'] : '">', '</a></li>
		</ul>';
	...
	echo'
		  <div class="copyright">', theme_copyright(), ' <br>
		  ', $txt['themecopyright'], ' ';
		  	// Show the load time?
...
function theme_linktree($force_show = false)
{
	...
	echo '
				<div class="navigate_section">
					<ul>';
					echo '<li class="first"><a href="', $scripturl, '"><i class="fa-solid fa-house"></i></a></li>';
