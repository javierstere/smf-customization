...
function template_html_above()
{
    ...
    loadCSSFile('jquery.sceditor.theme', array('minimize' => false));
...
function template_body_above()
{
	...
	<div id="header">
		<h1 class="forumtitle">
			<a style="display: flex;" href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? '<img src="'. $settings['images_url']. '/custom/logo.png" alt="' . $context['forum_name'] . '" title="' . $context['forum_name'] . '" >' : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" title="' . $context['forum_name'] . '" >', '</a>
		</h1>';
