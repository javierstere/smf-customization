  ...
  <div class="column _3">
	...
	foreach ($context['categories'] as $category)
	{
		...
		if ($category['can_collapse'])
			...
			echo '
					<span class="catarrow">', $category['link'], '</span>
...
function template_ic_block_recent()
{
	global $context, $scripturl, $settings, $txt;
		...
		// This is the "Social Media Icons" bar.
		...
		if (!empty($settings['social_icons_menu_enabled']))
{
	...
	echo '
			<div class="recent_grid_row"> 
				...
				<div class="recent_grid_column recentpost">', $post['link'], '<br> ', $post['poster']['link'], ' ', $post['time'], '</div>
